...
Текущий релиз содержит проверенные цели для:
...
В обеих сборках оригинальные байты `74 09`, патченные байты `74 18`.
...
Не гарантировано. Патчер безопасно откажется работать, если ни один известный проверенный RVA не содержит ожидаемые оригинальные/патченные байты.
